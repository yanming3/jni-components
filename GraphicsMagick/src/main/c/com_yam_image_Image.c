...
JNIEXPORT void JNICALL Java_com_yam_image_Image_init
  (JNIEnv *env, jobject obj)
  {
        InitializeMagick(NULL);
  }

JNIEXPORT void JNICALL Java_com_yam_image_Image_destroy
  (JNIEnv *env, jobject obj)
  {
         DestroyMagick();
  }
...
JNIEXPORT jlong JNICALL Java_com_yam_image_Image_newImageHandle
  (JNIEnv *env, jobject obj)
  {
...
JNIEXPORT void JNICALL Java_com_yam_image_Image_destroyImageHandle
...
JNIEXPORT jlong JNICALL Java_com_yam_image_Image_getHeight
  (JNIEnv *env, jobject obj, jlong hd)
  {
        unsigned long h;
...
JNIEXPORT jlong JNICALL Java_com_yam_image_Image_getWidth
  (JNIEnv *env, jobject obj, jlong hd)
  {
        unsigned long w;
...
JNIEXPORT jstring JNICALL Java_com_yam_image_Image_getFormat
  (JNIEnv *env, jobject obj, jlong hd)
  {
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_setFormat
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_setCompressQuality
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_setBackgroundColor
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_setBorderColor
  (JNIEnv *env, jobject obj, jlong hd, jstring color)
  {
          const char* c=(*env)->GetStringUTFChars(env,color,0);
          PixelWand *background;
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_setDepth
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_setGravity
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_readImage
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_readImageBlob
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_writeImage
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_strip
  (JNIEnv *env, jobject obj, jlong hd)
  {
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_crop
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_scale
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_sample
  (JNIEnv *env, jobject obj, jlong hd, jlong columns,jlong rows)
  {
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_sharpen
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_rotate
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_roll
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_extent
  (JNIEnv *env, jobject obj, jlong hd, jlong width, jlong height, jlong x, jlong y)
  {
        MagickPassFail status=MagickPass;
...
JNIEXPORT jint JNICALL Java_com_yam_image_Image_resize
